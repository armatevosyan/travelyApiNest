...
exports.childCategorySeeds = exports.categorySeeds = void 0;
const category_entity_1 = require("../../modules/categories/category.entity");
const category_enum_1 = require("../../modules/categories/category.enum");
exports.categorySeeds = [
    {
        name: 'Food & Drink',
        slug: category_enum_1.MainCategoryEnum.FOOD_AND_DRINK,
    ...
    {
        name: 'Accommodation',
        slug: category_enum_1.MainCategoryEnum.ACCOMMODATION,
    ...
    {
        name: 'Entertainment',
        slug: category_enum_1.MainCategoryEnum.ENTERTAINMENT,
    ...
    {
        name: 'Shopping',
        slug: category_enum_1.MainCategoryEnum.SHOPPING,
    ...
    {
        name: 'Transport',
        slug: category_enum_1.MainCategoryEnum.TRANSPORT,
    ...
    },
    {
        ...
        slug: category_enum_1.MainCategoryEnum.HEALTH_AND_WELLNESS,
    ...
    },
    {
        ...
        slug: category_enum_1.MainCategoryEnum.NATURE_AND_OUTDOORS,
...
class CategorySeeder {
    async run(dataSource) {
        ...
        for (const categoryData of exports.categorySeeds) {
        ...
        for (const childData of exports.childCategorySeeds) {
            ...
            if (!existingChild) {
                ...
                console.log(`✅ Created child category: ${childData.name} (parent: ${parentId})`);
            }
            else {
